...
(function (root) {
  ...
  function flush(id) {
    ...
    Object.keys(countries).forEach(function (code) {
      ...
      else layer.bindTooltip(value.label, {sticky: true});
    });
  ...
  function attach(element, map) {
    ...
    const state = {map: map, active: true};
    state.projection = root.WLVEqualEarth ? root.WLVEqualEarth.attach(element, map) : null;
